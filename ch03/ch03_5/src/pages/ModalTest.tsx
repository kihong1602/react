    ...
    <section className={'mt-4'}>
      ...
      <Modal open={open}>
        <ModalContent onCloseIconClicked={closeClicked}>
          ...
          <ModalAction>
            <Button className={'w-24 normal-case btn-primary btn-sm'} onClick={acceptClicked}>Accept</Button>
            <Button className={'w-24 normal-case btn-sm'} onClick={closeClicked}>Close</Button>
          </ModalAction>
        </ModalContent>
      </Modal>
    </section>
